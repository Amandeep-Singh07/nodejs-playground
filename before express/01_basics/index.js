...
//   const fullURL = new URL(req.url, "http://localhost:3000"); // called a constructor function of class url
//   console.log(fullURL);
//   res.end(fullURL.href);
// })
...
///******************************  Task: URL Analyzer Server ************************************ */

// Create a Node.js server that analyzes the URL and responds based on different parts of it
// http://localhost:3000/product/101?category=electronics&discount=10
// Extract: Protocol,host,port,pathname,path segments,product id(from path),query parameters
