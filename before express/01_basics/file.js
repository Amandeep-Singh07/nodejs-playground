...
// Async write to a file (non-blocking)
// fs.writeFile('example_async.txt', 'Hello, this is an async sample text file.....', (err) => {
//     if (err) throw err;
//     console.log('Async file has been saved!'); // this particular line will be executed only after the file is written successfully, demonstrating the non-blocking nature of the async method.
// });
...
// const result = fs.readFileSync("./before express/01_basics/contact.txt", "utf8");
// console.log(result);

// // Read from a file (async)
// fs.readFile("./before express/01_basics/contact.txt", "utf8", (err, result) => {
//   if (err) throw err;
//   console.log(result);
// });
